...
How to free up a pin for CS to allow SPI access to SD card?
...
- MIDI input (via USB, for settings options/forwarding notes and drums)
- MIDI output (via TRS/DIN, for sending triggers, notes and envelopes)
- Integrate CV inputs
